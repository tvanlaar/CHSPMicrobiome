...
dadaFs[[1]]
save(dadaFs, file="../RData/dadaFs.RData")
```
...
dadaRs[[1]]
save(dadaRs, file="../RData/dadaRs.RData")
```

##Merge paired reads
```{r}
mergers <- mergePairs(dadaFs, derepFs, dadaRs, derepRs, verbose=TRUE)
save(mergers, file="../RData/mergers.RData")
```
...
head(track)
write.csv(track, "../dada2sheets/track.csv")
```
